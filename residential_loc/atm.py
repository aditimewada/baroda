...
from residential_loc.latitude import listlat
place = list()
length = list()
print("--------------TOP RESIDENTIAL AREAS---------------")
for i in listlat:
...
# uncomment the above url and comment the below url to get top location conatining lesser number of ATMs
	...
	url = 'https://maps.googleapis.com/maps/api/place/nearbysearch/json?location='+data1+','+data2+'&radius=200&type=bank&key=AIzaSyCUj1RJqTJPbvFxwUv6XR7SQnfJB0hdoyU'
